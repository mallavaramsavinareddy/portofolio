...
export function IconExternalLink({ size = 18 }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export function IconAward({ size = 20 }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export function IconSparkle({ size = 20 }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor">
      <path d="M12 2l1.09 3.26L16 6l-2.91 1.09L12 10.5 10.91 7.09 8 6l2.91-.74L12 2zm0 11.5l.82 2.46 2.59.68-2.59.68L12 19.5l-.82-2.46-2.59-.68 2.59-.68L12 13.5zM5 8l.73 2.18L8 11l-2.27.82L5 14l-.73-2.18L2 11l2.27-.82L5 8zm14 0l.73 2.18L22 11l-2.27.82L19 14l-.73-2.18L16 11l2.27-.82L19 8z" />
    </svg>
  );
}
